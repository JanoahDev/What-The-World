...
from vintage_helpers import get_image_from_api, commentator_agent, vision_agent
...
def main():
    ...
    while True:
        ...
        output_string = vision_agent(output_string)
        print("Agent generated string: " + output_string)

        output_string = commentator_agent(output_string)
